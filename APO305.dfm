object FCobxUse: TFCobxUse
  ...
  object pnlCabecera: TPanel
    ...
    object TLabel
      ...
      Width = 251
      Height = 27
      Caption = 'Registro Cobranza por USE'
    ...
    object pnlInicio: TPanel
      ...
      object dblcUProceso: TwwDBLookupCombo
        ...
        Selected.Strings = (
          'UPROID'#9'4'#9'ID'#9'F'
          'UPRONOM'#9'75'#9'Unidad de Proceso'#9'F')
        DataField = 'UPROID'
        DataSource = DM1.dsCobxUse
    ...
    object dbgAportes: TwwDBGrid
      ...
      Selected.Strings = (
        ...
        'ASOID'#9'11'#9'Código '#9'F'
        'ASOCODMOD'#9'13'#9'Código Modular'#9'F'
        'ASOAPENOM'#9'31'#9'Apellidos y Nombres'#9'F'
        'FORPAGOABR'#9'13'#9'Forma de ~Pago'#9'F'
        'TRANSMTO'#9'5'#9'Monto'#9'F'
        'BANCOID'#9'5'#9'Banco'#9'F'
        'CCBCOID'#9'20'#9'Cuenta Corriente'#9'F'
